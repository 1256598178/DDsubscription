...
.act-t2{padding-left: 20px;padding-right: 20px;padding-top: 22px;padding-bottom: 20px;flex-direction: row;justify-content: flex-start;align-items: center;}
.act-t2-content{margin-right: 29px;flex-direction: row;justify-content: flex-start;align-items: center;}
...
.act-t2-info{flex-direction: row;justify-content: flex-start;align-items: center;margin-bottom: 23px;}
...
.btn-box{flex-direction: row;justify-content: flex-end;align-items: center;}
