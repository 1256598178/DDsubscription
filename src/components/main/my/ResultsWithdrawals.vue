            ...
            <div class="times">
                <div class="list payment">
                  <div class="result-text">
                    ...
                    <text class="time">05-09  13:32</text>
                  </div>
                  <image class="icon" src="../src/common/img/dui.png"></image>
                </div>
                <div class="list not">
                  ...
                  <image class="icon icon-bottom" src="../src/common/img/qian.png"></image>
                </div>
            </div>
        </div>
...
.list{margin-left: 55px;padding-left: 15px;position:relative;flex-direction: row;align-items: flex-start;height: 110px;overflow: visible;}
