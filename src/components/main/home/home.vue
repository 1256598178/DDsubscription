    ...
    <list class="homeMain">
            ...
            <div class="eightBox" v-for="(val,key,index) in eightItemsList" :key="index">
                ...
                <div class="eightBoxImgs">
                    <scroller scroll-direction="horizontal" class="eightBoxImgsScroller">
                        <div :class="['eightBoxImgItem',index==val.length?'marginR0':'']" v-for="(item,index) in val" :key="index">
        ...
        <cell>
            <div class="eightBox">
                ...
                <div class="eightBoxImgs">
                    <scroller scroll-direction="horizontal" class="eightBoxImgsScroller">
                        <div :class="['eightBoxImgItem',index==homeManger.length?'marginR0':'']" v-for="(item,index) in homeManger" :key="index">
