<template>
	<div class="wrapper">
		...
		<div class="act-nav">
			<div class="act-nav-font" @click="stockin">
				<text class="act-nav-fonts">存入</text>
				<!-- <text class="act-nav-fonts">(10)</text> -->
			</div>
			<text class="act-nav-font act-nav-crt" @click="stockout">取出</text>
		</div>
		<list class="activity-list">
			...
			<cell class="cell" v-for="(val,key) in info" v-if="info.length > 0">
				<div class="act-content">
					<div class="act-stock-t">
						<text class="wine-name">百威精酿 没有数据</text>
						<text class="wine-num">1瓶</text>
					</div>
