<template>
	<div class="wrapper">
		...
		<div class="zhye-link" @click="toPage('managerBalanceIncome',{text:'text'})">
		...
		<div class="zhye-link" @click="toPage('managerpayPsw',{text:'text'})">
	...
	export default {
		...
		methods:{
		    toBack_G(){
		        ...
		        this.$router.push({name:'managermyIndex'});
			},
